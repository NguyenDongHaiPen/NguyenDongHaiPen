...
# ===========================================================================
HOST = "hai"   # shown as  hai@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Developer · Student · Creator"),
    ("kv", "Focus", "Building cool things with code"),
    ("kv", "Edu", "Computer Science Student"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Lang", "Python, JavaScript, TypeScript"),
    ("kv", "Frontend", "React, Next.js, HTML/CSS"),
    ("kv", "Backend", "Node.js, Flask, FastAPI"),
    ("kv", "AI / ML", "PyTorch, TensorFlow, LLMs"),
    ("kv", "Tools", "Git, Docker, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "15 public repositories on GitHub"),
    ("bul", "Passionate about AI & open source"),
]
